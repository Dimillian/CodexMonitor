    ...
    <section className="settings-section">
      ...
      <div className="settings-field settings-shortcuts-search">
        <label className="settings-field-label" htmlFor="settings-shortcuts-search">
          {t('settings.keyboard_shortcuts.search_shortcuts')}
        </label>
        <div className="settings-field-row">
          <input
            id="settings-shortcuts-search"
            className="settings-input"
            placeholder={t('settings.keyboard_shortcuts.search_shortcuts')}
            value={searchQuery}
        ...
        <div className="settings-help">{t('settings.keyboard_shortcuts.search_help')}</div>
      </div>
      ...
      {filteredGroups.length === 0 && (
        <div className="settings-empty">
          {t('settings.keyboard_shortcuts.no_results', { query: searchQuery.trim() })}
        </div>
      )}
    </section>
  );
